...
class DetailSimilarStore extends StatefulWidget {
  String customerNo;
  String customerName;
  Store store;
  ...
  @override
  State<DetailSimilarStore> createState() => _DetailSimilarStoreState();
}

class _DetailSimilarStoreState extends State<DetailSimilarStore> {
  bool onEdit = true;
