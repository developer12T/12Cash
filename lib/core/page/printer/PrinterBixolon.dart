...
class PrinterBixolon extends StatefulWidget {
  // const PrinterBixolon({super.key});

  @override
  PrinterBixolonState createState() => PrinterBixolonState();
}

class PrinterBixolonState extends State<PrinterBixolon> {
  String _info = "";
  String _msj = '';
  ...
  //       Permission.locationWhenInUse, // Required for older Android versions
  //     ].request();

  //     if (statuses[Permission.bluetoothScan]!.isDenied ||
  //         statuses[Permission.bluetoothConnect]!.isDenied) {
  //       print("Bluetooth permissions denied. Please enable them in settings.");
  //       openAppSettings(); // Opens device settings if permissions are denied
  //     }
  //   }
  // }
