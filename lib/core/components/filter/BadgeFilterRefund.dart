...
class BadageRefundFilter {
  static void showFilterSheet(
      ...
      required Future<void> Function(int selected) onSearch}) {
                ...
                return Container(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      _buildFooter(
                          context, isSelect, setModalState, onClear, onSearch)
                    ],
                  ),
                );
              },
  ...
  static Widget _buildFooter(
      ...
      Future<void> Function(int selected) onSearch) {
    return Padding(
