...
class BadageGiveAwaysFilter {
  static void showFilterSheet(
      ...
      required Future<void> Function(List<String> groups) onSearch}) {
                ...
                return Container(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      _buildFooter(
                          context, itemList, setModalState, onClear, onSearch)
                    ],
                  ),
                );
              },
  ...
  static Widget _buildFooter(
      ...
      Future<void> Function(List<String> groups) onSearch) {
    return Padding(
