...
class IconButtonWithLabelOld3 extends StatefulWidget {
  String? imagePath;
  final IconData icon;
  final String label;
  ...
  @override
  _IconButtonWithLabelOld3State createState() =>
      _IconButtonWithLabelOld3State();
}

class _IconButtonWithLabelOld3State extends State<IconButtonWithLabelOld3> {
  ...
  Widget build(BuildContext context) {
    ...
    return Column(
      children: [
        ...
        Text("${widget.label}", style: Styles.black18(context)),
      ],
    );
  }
}
