...
class ItemSummarize extends StatefulWidget {
  ...
  ItemSummarize({
    ...
    required this.indicatorTouchedLineColor,
    required this.indicatorSpotStrokeColor,
    required this.indicatorTouchedSpotStrokeColor,
    required this.bottomTextColor,
    required this.bottomTouchedTextColor,
...
class _ItemSummarizeState extends State<ItemSummarize> {
  ...
  Widget bottomTitleWidgets(double value, TitleMeta meta) {
    ...
    final style = TextStyle(
      color: isTouched ? widget.bottomTextColor : widget.bottomTextColor,
